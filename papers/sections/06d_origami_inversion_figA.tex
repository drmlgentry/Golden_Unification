% ============================================================
% 06d_origami_inversion_figA.tex
% Figure A: local patch + inversion + holonomy orientation flip
% ============================================================
...
% Left: a "pentagonal fan" with central vertex (origami patch)
\coordinate (C) at (0,0);
...
% Center: indicate inversion (push vertex through)
\draw[->, very thick] (2.6,0.0) -- (4.2,0.0);
\node at (3.4,0.35) {\small inversion};
\node at (3.4,-0.35) {\small $z \mapsto -z$};

% Right: same patch but label orientation-reversed loop (phase flip)
...
\end{tikzpicture}
\caption{\textbf{Toy holonomy picture for CP-sensitive phases.}
